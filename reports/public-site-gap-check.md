...
| Link instances extracted | 907 | Includes repeated navigation, source, report, CSV, and external links. |
| Internal link instances checked | 554 | Relative `.html`, `.md`, `.csv`, and report-index links resolve to repository files. |
