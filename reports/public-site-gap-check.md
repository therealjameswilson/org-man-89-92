...
| Link instances extracted | 904 | Includes repeated navigation, source, report, CSV, and external links. |
| Internal link instances checked | 551 | Relative `.html`, `.md`, `.csv`, and report-index links resolve to repository files. |
